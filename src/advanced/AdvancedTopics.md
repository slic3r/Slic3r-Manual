...
part of a script, or as part of another tool, such as Printrun[^3].

All options found in the GUI can be used from the command line in the
form of switch parameters. The latest version of these are given below,
and the most up-to-date information can be found by issuing the command:
...
Example scripts can be found in the GitHub repository[^5].
...
[^3]: https://github.com/kliment/Printrun

[^4]: <https://github.com/alexrj/Slic3r/wiki/Writing-post-processing-scripts>

[^5]: <https://github.com/alexrj/Slic3r/tree/master/utils/post-processing>
