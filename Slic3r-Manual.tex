...
%%% FIRST SLICE %%%
\ifgetting
\chapter{\emph{First Slice}}
\thispagestyle{empty}
\markboth{First Slice}{Slic3r User Manual}
{\include{First}}
\fi
%%% END FIRST SLICE %%%
...
\thispagestyle{empty}
\markboth{Advanced}{Slic3r User Manual}
{\include{Advanced}}
\fi
%%% END ADVANCED %%%
...
%%% CUTTING EDGE %%%
\ifadvanced
\chapter{\emph{The Cutting Edge of Slic3r}}
\thispagestyle{empty}
\markboth{The Cutting Edge of Slic3r}{Slic3r User Manual}
{\include{Edge}}
\fi
%%% END CUTTING EDGE %%%
